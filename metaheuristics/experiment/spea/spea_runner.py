...
from metaheuristics.spea.spea_graph import SPEA2GraphOptimizer


@dataclass
class SPEA2ExperimentHyperparams:
    config_id: int
    population_size: int
    generations: int
...
class SPEA2ExperimentExecuter:
    ...
    def run_experiment(self, dataset_id: str, hyperparams: SPEA2ExperimentHyperparams, n_repeat: int = 31):
        dataset = self.datasets[dataset_id]
        output_path = f"experiments/spea/experiment_{dataset_id}.json"
        ...
        for i in range(n_repeat):
            ...
            self.optimizer = SPEA2GraphOptimizer(
            ...
            pareto_data = [
                ...
                for (route, fitness) in self.optimizer.archive
            ]
